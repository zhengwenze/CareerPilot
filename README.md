...
│   │   │   └── versions/           # 迁移脚本
│   │   ├── app/
│   │   │   ├── core/              # 核心模块（配置、安全、响应、错误、日志）
│   │   │   ├── db/                # 数据库连接与会话管理
│   │   │   ├── models/            # SQLAlchemy 模型
│   │   │   ├── prompts/           # AI prompt 模板（按业务域分组）
│   │   │   │   ├── match/         # 匹配报告相关 prompt
│   │   │   │   ├── mock_interview/# 模拟面试相关 prompt
│   │   │   │   ├── resume/        # 简历解析相关 prompt
│   │   │   │   └── tailored_resume/# 专属简历相关 prompt
│   │   │   ├── routers/           # API 路由
...
├── docker-compose.middleware.yml  # 中间件编排（PostgreSQL、Redis、MinIO）
├── README.md
└── AGENTS.md
```
